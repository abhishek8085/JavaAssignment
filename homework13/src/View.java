...
public class View extends AbstractView {
    ...
    protected int getPlayerInput(PlayerInterface playerInterface) {
        ...
        if ( playerInterface.getName().equals(GlobalConfig.getUserName()) )
        {
            System.out.print(playerInterface.getName() +"'s your move: ");
        }
        else
        {
            System.out.print(playerInterface.getName() +"'s move");
        }



        if (!GlobalConfig.getUserName().equals(playerInterface.getName()))
        {
            return -1;
        }
